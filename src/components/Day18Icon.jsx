...
import styles from "./Day18Icon.module.css";
import React, {useState, useCallback, useEffect} from "react";
import DiaryCheckPopup from "../components/DiaryCheckPopup_1";
import PortalPopup from "../components/PortalPopup";

const Day18Icon = ({ propTop, propLeft, diaryStatus, diaryContent, diaryConsolation, diarySummary, diaryDay }) => {
  ...
  const [imageSrc, setImageSrc]=useState('/day18.svg');
  //1: 슬픔, 2: 기쁨, 3: 화남
  useEffect(() => {
    switch(diaryStatus){
      case '슬픔':
        setImageSrc('/day181.svg');
        break;
      case '행복':
        setImageSrc('/day182.svg');
        break;
      case '화남':
        setImageSrc('/day183.svg');
        break;
      default:
        setImageSrc('/day18.svg');
    }
  }, [diaryStatus]);
  ...
  return (
    <>
      <img
        className={styles.day18Icon}
        alt=""
        src={imageSrc}
        style={day18IconStyle}
